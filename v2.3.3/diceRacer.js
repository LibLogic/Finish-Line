function game() {
  ...
  function logGameStats(currentPlayer, markerToMove) {
    if (currentPlayer.markerAPos >= 4 && currentPlayer.markerBPos >= 4 && currentPlayer.markerCPos >= 4) {
      console.clear();
      console.log('\n\n');
      console.log(hand);
  ...
  function moveCheck(currentPlayer, markerToMove) {
      if (currentPlayer[markerToMove] >= 5 - 1) {
        return true;
      }
      return false;
  }
  ...
  function initializeGame() {
    ...
    class Player {
      constructor(name) {
        // this.markerAFinished = false;
        // this.markerBFinished = false;
        // this.markerCFinished = false;
        this.markerAPos = -1;
        this.markerBPos = -1;
        this.markerCPos = -1;
        this.name = name;
